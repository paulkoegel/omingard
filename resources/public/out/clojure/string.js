...
{var pred__13874 = cljs.core._EQ_;var expr__13875 = limit;if(cljs.core.truth_(pred__13874.call(null,(1),expr__13875)))
...
{var ch = s.charAt(index);var temp__4124__auto___13881 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___13881))
{var replacement_13882 = temp__4124__auto___13881;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_13882)));
} else
{buffer.append(ch);
}
{
